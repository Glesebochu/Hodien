...
// in frontend/test/mocks/search_mocks.dart.
...
import 'package:frontend/services/preprocessing_service.dart' as _i11;
import 'package:frontend/services/query_profile_matcher.dart' as _i12;
import 'package:frontend/services/translator_service.dart' as _i8;
...
class _FakeTranslationResult_20 extends _i1.SmartFake
    implements _i8.TranslationResult {
  _FakeTranslationResult_20(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTranslator extends _i1.Mock implements _i8.Translator {
  MockTranslator() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<_i8.TranslationResult> translateText(String? inputText) =>
      (super.noSuchMethod(
            Invocation.method(#translateText, [inputText]),
            returnValue: _i7.Future<_i8.TranslationResult>.value(
              _FakeTranslationResult_20(
                this,
                Invocation.method(#translateText, [inputText]),
              ),
            ),
          )
          as _i7.Future<_i8.TranslationResult>);
}

/// A class which mocks [PreprocessingService].
///
/// See the documentation for Mockito's code generation for more information.
class MockPreprocessingService extends _i1.Mock
    implements _i11.PreprocessingService {
  MockPreprocessingService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<String> sendInputToPreprocessor({
    ...
    required String? userId,
      ...
      (super.noSuchMethod(
            Invocation.method(#sendInputToPreprocessor, [], {
...
/// A class which mocks [QueryProfileMatcher].
///
/// See the documentation for Mockito's code generation for more information.
class MockQueryProfileMatcher extends _i1.Mock
    implements _i12.QueryProfileMatcher {
  MockQueryProfileMatcher() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i7.Future<List<Map<String, dynamic>>> matchQueryAndProfile({
    required String? userId,
    required String? queryId,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#matchQueryAndProfile, [], {
              #userId: userId,
              #queryId: queryId,
            }),
